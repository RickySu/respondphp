...
RP_BEGIN_ARG_WITH_RETURN_OBJ_INFO(ARGINFO(respond_network_resolver, getaddrinfo), "Respond\\Async\\PromiseInterface", 0)
    ZEND_ARG_TYPE_INFO(0, hostname, IS_STRING, 0)
ZEND_END_ARG_INFO()

RP_BEGIN_ARG_WITH_RETURN_OBJ_INFO(ARGINFO(respond_network_resolver, getnameinfo), "Respond\\Async\\PromiseInterface", 0)
